...
export function WalletMethod_getwalletnftsmultichain() {
  return (
    <WalletMethod
      method="Get Wallet NFTs (Multichain / EVM)"
      cu={16299}
      description={"Returns a list of NFTs owned by the specified wallet for EVM chains"}
...
const USE_CASES = [
  "Display NFTs owned by a wallet in EVM chain",
