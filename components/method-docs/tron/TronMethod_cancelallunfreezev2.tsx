...
export function TronMethod_cancelallunfreezev2(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="cancelallunfreezev2"
      network="tron"
      cu={20}
      description={"Cancels all pending Stake 2.0 unfreeze operations for an account and re-stakes the TRX."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Cancels all pending Stake 2.0 unfreeze operations for an account and re-stakes the TRX."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/cancelallunfreezev2 \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/cancelallunfreezev2';
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/cancelallunfreezev2';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "[Required] The account address canceling its pending unfreezes",
  },
{
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a request to cancel all of an account's pending, not-yet-matured Stake 2.0 unfreezes and restake that TRX.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address whose pending unfreezes are being cancelled, in hex format.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, CancelAllUnfreezeV2Contract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Change your mind after calling unfreezebalancev2 and re-stake the TRX instead of withdrawing it",
];

const CONSTRAINTS = [
  "Cancels every pending unfreeze for the account at once; cannot cancel a single one selectively",
];
