...
export function TronMethod_updatewitness(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="updatewitness"
      network="tron"
      cu={20}
      description={"Updates the URL associated with a registered witness account."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Updates the URL associated with a registered witness account."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/updatewitness \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "update_url": "example", "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/updatewitness';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "update_url": "example", "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/updatewitness';
...
const REQUEST_PARAMS: RequestParamProp = [
  ...
  {
    paramName: "update_url",
    type: "string",
    paramDescription: "[Required] The new URL for the witness",
  },
  {
    paramName: "visible",
    type: "boolean",
...
},
{
  ...
  childrenParams: [
      ...
      childrenParams: [
        {
          ...
          type: "object",
          childrenParamsType: "object",
          paramDescription: "The decoded fields of the contract — here, a request by a Super Representative to update their public URL.",
          childrenParams: [
            {
              paramName: "owner_address",
              type: "string",
              paramDescription: "[Required] The address of the witness (SR/SR candidate) updating their information, in hex format.",
            },
            {
              paramName: "update_url",
              type: "string",
              paramDescription: "[Required] The witness's new public URL, UTF-8 encoded as a hex string.",
            },
          ],
        },
        {
    ...
    },
    {
      paramName: "type",
      type: "string",
      paramDescription: "The human-readable name of the contract type being executed (here, WitnessUpdateContract).",
    },
  ],
},
    {
...
const USE_CASES = [
  "Update a Super Representative's published information URL",
];

const CONSTRAINTS = [
  "Only the witness's own owner_address can update its URL",
];
