...
export function TronMethod_unfreezebalance(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="unfreezebalance"
      network="tron"
      cu={20}
      description={"Creates a transaction to unfreeze previously frozen TRX under the legacy staking model."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction to unfreeze previously frozen TRX under the legacy staking model."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/unfreezebalance \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "resource": "example", "receiver_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/unfreezebalance';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "resource": "example", "receiver_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/unfreezebalance';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "[Required] The account address unfreezing TRX",
  },
  {
    paramName: "resource",
    type: "string",
    paramDescription: "Resource being unfrozen: BANDWIDTH or ENERGY",
  },
  {
    paramName: "receiver_address",
    type: "string",
    paramDescription: "The address the resource was delegated to, if applicable",
  },
{
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a Stake 1.0 request to release a matured frozen balance.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address unfreezing its previously staked TRX, in hex format.",
                },
                {
                  paramName: "resource",
                  type: "string",
                  paramDescription: "The resource type the balance was originally staked for, either BANDWIDTH or ENERGY.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, UnfreezeBalanceContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Reclaim TRX frozen under the legacy freezebalance model once the lock period ends",
];

const CONSTRAINTS = [
  "Fails if the frozen_duration lock period hasn't elapsed yet",
  "Also removes any voting rights associated with the frozen balance",
];
