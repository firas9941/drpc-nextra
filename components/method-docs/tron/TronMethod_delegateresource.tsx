...
export function TronMethod_delegateresource(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="delegateresource"
      network="tron"
      cu={20}
      description={"Creates a transaction to delegate bandwidth or energy from one account to another."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction to delegate bandwidth or energy from one account to another."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/delegateresource \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "receiver_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "balance": 1, "resource": "example", "lock": true, "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/delegateresource';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "receiver_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "balance": 1, "resource": "example", "lock": true, "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/delegateresource';
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a Stake 2.0 request to delegate staked resources to another account.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address delegating its staked resource, in hex format.",
                },
                {
                  paramName: "receiver_address",
                  type: "string",
                  paramDescription: "The address receiving the delegated resource, in hex format.",
                },
                {
                  paramName: "balance",
                  type: "integer",
                  paramDescription: "The amount of TRX, in sun, worth of staked resource being delegated.",
                },
                {
                  paramName: "resource",
                  type: "string",
                  paramDescription: "The resource type being delegated, either BANDWIDTH or ENERGY.",
                },
                {
                  paramName: "lock",
                  type: "boolean",
                  paramDescription: "Whether the delegated balance is locked, preventing the delegator from undelegating it before a fixed period elapses.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, DelegateResourceContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Share staked bandwidth/energy with a hot wallet or contract-calling address",
  "Sponsor gas (energy) for users of a dApp without transferring TRX ownership",
];

const CONSTRAINTS = [
  "Requires the owner_address to already have Stake 2.0 frozen balance to delegate from",
  "When lock is true, the delegation cannot be undone via undelegateresource until the lock period ends",
];
