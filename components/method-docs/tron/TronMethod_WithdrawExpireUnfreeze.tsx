...
export function TronMethod_withdrawexpireunfreeze(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="withdrawexpireunfreeze"
      network="tron"
      cu={20}
      description={"Creates a transaction to withdraw TRX whose Stake 2.0 unfreeze waiting period has expired."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction to withdraw TRX whose Stake 2.0 unfreeze waiting period has expired."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/withdrawexpireunfreeze \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/withdrawexpireunfreeze';
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/withdrawexpireunfreeze';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "[Required] The account address withdrawing its unfrozen TRX",
  },
  {
    paramName: "visible",
    type: "boolean",
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a Stake 2.0 request to withdraw a matured (fully waited-out) unfrozen balance to liquid TRX.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address withdrawing its matured unfrozen balance, in hex format.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, WithdrawExpireUnfreezeContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  ...
  "Complete the Stake 2.0 unstaking flow by withdrawing TRX after its lock period ends",
];

const CONSTRAINTS = [
  "Fails (or withdraws 0) if no unfreeze has completed its waiting period yet",
];
