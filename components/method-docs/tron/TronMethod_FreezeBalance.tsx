...
export function TronMethod_freezebalance(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="freezebalance"
      network="tron"
      cu={20}
      description={"Creates a transaction to freeze TRX in exchange for bandwidth or energy (legacy model)."}
      useCases={USE_CASES}
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/freezebalance \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/freezebalance';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "frozen_balance": 1, "frozen_duration": 1, "resource": "example", "receiver_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/freezebalance';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "[Required] The account address freezing TRX",
  },
  {
    paramName: "frozen_balance",
    type: "integer",
    paramDescription: "[Required] Amount of TRX to freeze, in sun",
  },
  {
    paramName: "frozen_duration",
    type: "integer",
    paramDescription: "[Required] Freeze duration in days (typically 3)",
  },
  {
    paramName: "resource",
    type: "string",
    paramDescription: "[Required] Resource to receive: BANDWIDTH or ENERGY",
  },
  {
    paramName: "receiver_address",
    type: "string",
    paramDescription: "Optional address to delegate the resulting resource to",
  },
  {
    paramName: "visible",
    type: "boolean",
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a Stake 1.0 request to freeze TRX for a resource.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address freezing its TRX balance, in hex format.",
                },
                {
                  paramName: "frozen_balance",
                  type: "integer",
                  paramDescription: "The amount of TRX, in sun, to freeze for the specified resource.",
                },
                {
                  paramName: "frozen_duration",
                  type: "integer",
                  paramDescription: "The number of days this balance will remain locked before it can be unfrozen.",
                },
                {
                  paramName: "resource",
                  type: "string",
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, FreezeBalanceContract).",
        },
      ],
    },
    {
