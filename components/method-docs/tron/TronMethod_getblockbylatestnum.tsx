...
export function TronMethod_getblockbylatestnum(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="getblockbylatestnum"
      network="tron"
      cu={20}
      description={"Returns a list of the most recent blocks up to a specified count."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Returns a list of the most recent blocks up to a specified count."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getblockbylatestnum \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getblockbylatestnum';
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getblockbylatestnum';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    paramName: "num",
    type: "integer",
    paramDescription: "[Required] Number of most recent blocks to return",
  },
    {
  paramName: "visible",
  type: "boolean",
...
const USE_CASES = [
  "Also available as GET",
    "Poll for the last N blocks to display a live block feed"
];

const CONSTRAINTS = [
  "Large num values increase response size and latency",
