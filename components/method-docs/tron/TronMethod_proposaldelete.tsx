...
export function TronMethod_proposaldelete(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="proposaldelete"
      network="tron"
      cu={20}
      description={"Creates a transaction to cancel a previously submitted network parameter proposal."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction to cancel a previously submitted network parameter proposal."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposaldelete \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "proposal_id": 1, "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposaldelete';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "proposal_id": 1, "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposaldelete';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "[Required] The original proposer's address",
  },
  {
    paramName: "proposal_id",
    type: "integer",
    paramDescription: "[Required] The numeric ID of the proposal to cancel",
  },
  {
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a request by a proposal's creator to withdraw it before it takes effect.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address of the witness withdrawing their own proposal (must match the proposal's creator), in hex format.",
                },
                {
                  paramName: "proposal_id",
                  type: "integer",
                  paramDescription: "The numeric identifier of the proposal being withdrawn.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, ProposalDeleteContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Withdraw a proposal before it's approved or expires",
];

const CONSTRAINTS = [
  "Only the original owner_address that created the proposal can cancel it",
];
