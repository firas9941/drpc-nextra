...
export function TronMethod_clearabi(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="clearabi"
      network="tron"
      cu={20}
      description={"Creates a transaction that clears the stored ABI of a smart contract."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction that clears the stored ABI of a smart contract."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/clearabi \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "contract_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/clearabi';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "contract_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/clearabi';
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a request to wipe a deployed contract's stored ABI.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "The address authorized to clear the contract's ABI (must match the contract's origin address), in hex format.",
                },
                {
                  paramName: "contract_address",
                  type: "string",
                  paramDescription: "The address of the smart contract whose ABI is being cleared, in hex format.",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, ClearABIContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Remove a contract's public ABI, e.g. to obscure implementation details post-audit",
];

const CONSTRAINTS = [
  "Only the contract's owner_address can clear its ABI",
  "This does not remove or change the contract's bytecode, only the stored ABI",
];
