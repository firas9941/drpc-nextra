...
export function TronMethod_proposalapprove(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="proposalapprove"
      network="tron"
      cu={20}
      description={"Creates a transaction for a witness to approve or withdraw approval of a network parameter proposal."}
      useCases={USE_CASES}
      ...
      responseParamsDescription={
        "Creates a transaction for a witness to approve or withdraw approval of a network parameter proposal."
      }
      {...props}
    />
  );
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposalapprove \\
     --header 'accept: application/json' \\
     --header 'content-type: application/json' \\
     --data '{"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "proposal_id": 1, "is_add_approval": true, "visible": true}'`,
  },
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposalapprove';

const data = {"owner_address": "TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g", "proposal_id": 1, "is_add_approval": true, "visible": true};
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/proposalapprove';
...
const REQUEST_PARAMS: RequestParamProp = [
  ...
  },
  {
    ...
    type: "integer",
    paramDescription: "[Required] The numeric ID of the proposal",
  },
  {
    paramName: "is_add_approval",
    type: "boolean",
    paramDescription: "true to approve, false to withdraw a previous approval",
  },
  {
  ...
  childrenParams: [
    {
      ...
      childrenParams: [
          ...
          childrenParams: [
            {
              ...
              type: "object",
              childrenParamsType: "object",
              paramDescription: "The decoded fields of the contract — here, a witness's vote of approval or withdrawal on a chain-parameter proposal.",
              childrenParams: [
                {
                  paramName: "owner_address",
                  type: "string",
                  paramDescription: "[Required] The address of the witness casting this approval vote, in hex format.",
                },
                {
                  paramName: "proposal_id",
                  type: "integer",
                  paramDescription: "[Required] The numeric identifier of the proposal being voted on.",
                },
                {
                  paramName: "is_add_approval",
                  type: "boolean",
                  paramDescription: "[Required] Whether this vote adds approval for the proposal (true) or withdraws a previously given approval (false).",
                },
              ],
            },
            {
        ...
        },
        {
          paramName: "type",
          type: "string",
          paramDescription: "The human-readable name of the contract type being executed (here, ProposalApproveContract).",
        },
      ],
    },
    {
...
const USE_CASES = [
  "Cast a witness's approval vote on a proposed network parameter change",
];

const CONSTRAINTS = [
  "Only accounts currently registered as witnesses can approve proposals",
];
