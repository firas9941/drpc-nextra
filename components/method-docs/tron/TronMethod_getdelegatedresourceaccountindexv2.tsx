...
export function TronMethod_getdelegatedresourceaccountindexv2(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="getdelegatedresourceaccountindexv2"
      network="tron"
      cu={20}
      description={"Returns the Stake 2.0 list of accounts an address has delegated resources to or from."}
      useCases={USE_CASES}
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getdelegatedresourceaccountindexv2 \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getdelegatedresourceaccountindexv2';
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getdelegatedresourceaccountindexv2';
...
const RESPONSE_PARAMS: ReqResParam[] = [
  ...
  },
  {
    ...
    paramDescription: "Accounts this address has delegated resources to under Stake 2.0",
  },
  {
    paramName: "fromAccounts",
    type: "array_of_strings",
    paramDescription: "Accounts that have delegated resources to this address under Stake 2.0",
  },
];
