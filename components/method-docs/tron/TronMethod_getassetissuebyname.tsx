...
export function TronMethod_getassetissuebyname(props: GenericMethodPropsReplacing) {
  return (
    <TronMethod
      method="getassetissuebyname"
      network="tron"
      cu={20}
      description={"Returns TRC10 token details by its token name."}
      useCases={USE_CASES}
...
const CODE_SNIPPETS: Array<CodeSnippetObject> = [
  {
    ...
    code: () => `curl --request POST \\
     --url ${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getassetissuebyname \\
  ...
  {
    language: "js",
    code: () => `const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getassetissuebyname';
...
const url = '${DRPC_ENDPOINT_URL_TRON_PAID}/wallet/getassetissuebyname';
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    paramName: "value",
    type: "string",
    paramDescription: "[Required for GET] The TRC10 token's name",
  },
];
