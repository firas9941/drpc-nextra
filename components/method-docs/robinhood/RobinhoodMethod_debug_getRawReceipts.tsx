...
export function RobinhoodMethod_debug_getRawReceipts(props: GenericMethodPropsReplacing) {
  return (
    <EthereumMethod
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "Block number in hex, or a block tag, to fetch raw receipts for.",
    paramEnum: [
      {
        value: "latest",
        isDefault: true,
...
const RESPONSE_PARAMS: ReqResParam[] = [
  ...
  },
  {
    ...
    paramDescription: "The EIP-2718 binary-encoded receipts, one per transaction in the block.",
  },
];
