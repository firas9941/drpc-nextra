...
export function RobinhoodMethod_debug_getRawBlock(props: GenericMethodPropsReplacing) {
  return (
    <EthereumMethod
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "Block number in hex, or a block tag, to fetch the raw block for.",
    paramEnum: [
      {
        value: "latest",
        isDefault: true,
...
const RESPONSE_PARAMS: ReqResParam[] = [
  ...
  },
  {
    paramName: "result",
    type: "string",
    paramDescription: "The RLP-encoded block as a hexadecimal string.",
  },
];
