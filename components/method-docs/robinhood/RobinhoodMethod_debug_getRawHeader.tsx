...
export function RobinhoodMethod_debug_getRawHeader(props: GenericMethodPropsReplacing) {
  return (
    <EthereumMethod
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    ...
    type: "string",
    paramDescription: "Block number in hex, or a block tag, to fetch the raw header for.",
    paramEnum: [
      {
        value: "latest",
        isDefault: true,
...
const RESPONSE_PARAMS: ReqResParam[] = [
  ...
  },
  {
    paramName: "result",
    type: "string",
    paramDescription: "The RLP-encoded header as a hexadecimal string.",
  },
];
