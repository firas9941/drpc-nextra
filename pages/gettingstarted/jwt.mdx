...
When you're **Paid Tier** DRPC user and have enabled `JSON web token` in your key settings, JWTs are used as additional layer of security to authenticate your requests. JWT authentication is available only for HTTP.
